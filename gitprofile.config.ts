...
const CONFIG = {
  github: {
    username: 'briteal', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['briteal/Bioinformatics', 'briteal/Cool'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  seo: {
    title: 'Portfolio of Briteal Varda',
    description: '',
    imageURL: '',
  },
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://briteal.github.io',
    phone: '',
